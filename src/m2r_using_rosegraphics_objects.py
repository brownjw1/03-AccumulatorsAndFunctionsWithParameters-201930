...
#               move_by(), move_center_to(), detach_from()
#
#
...
#            It renders a display window after a certain delay
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            it is necessary when you want the user to decide when to close
#           the window. Otherwise, you have numerous other different methods for
#           closing the window
#
